...
public class Screen extends JPanel implements Runnable {
   ...
   public static Enemy[] enemies = new Enemy[100];
    ...
    public Screen(gWindow window) {
        
        window.addMouseListener(new keyHandle());
        window.addMouseMotionListener(new keyHandle());
        thread.start();
    ...
    public void define() {
        ...
        for(int i=0; i < tileset_ground.length; i++){
         ...
         for(int i=0; i < tileset_air.length; i++){
          ...
          tileset_enemy[0] = new ImageIcon("E:\\testGame\\tdTest\\src\\res\\trumpHead.png").getImage();
          tileset_enemy[1] = new ImageIcon("E:\\testGame\\tdTest\\src\\res\\hillaryHead.png").getImage();
        ...
        if(spawnFrame >= spawnTime){
            for (int i=0; i < enemies.length; i++){
                if(!enemies[i].inGame){
                    ...
                    if (i % 10 == 0){
                        enemies[i].spawnEnemy(Value.enemyGreen+1);
                    }
